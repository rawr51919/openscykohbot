...
class MTRNG extends commando.Command {
    ...
    async run(message, args) {
        ...
        if ((message.content.match(bot.commandPrefix+/^mtrng$/)) || (message.content.match(message.guild.commandPrefix+/^mtrng$/))){
        ...
        }else if ((message.content.match(bot.commandPrefix+/^mtrng ([0-9]*) ([0-9]*)+\b/) && !number[2]) || (message.content.match(message.guild.commandPrefix+/^mtrng ([0-9]*) ([0-9]*)+\b/) && !number[2])){
        ...
        }else if ((message.content.match(bot.commandPrefix+/^mtrng ([0-9]*) ([0-9]*) ([0-9]*)+\b/)) || (message.content.match(message.guild.commandPrefix+/^mtrng ([0-9]*) ([0-9]*) ([0-9]*)+\b/))){
            var numberarray=[]
            var numbertotal=0
