...
class MTRNG extends commando.Command {
    ...
    async run(message,args) {
        ...
        if (message.content.match(message.guild.commandPrefix+'mtrng')){
        ...
        }else if (message.content.match(message.guild.commandPrefix+'mtrng'+/^ ([0-9]*) ([0-9]*)+\b/) && !number[2]){
            if (number[0]>9007199254740992 || number[1]>4294967295 || (number[0]>9007199254740992 && number[1]>4294967295)){
        ...
        }else if (message.content.match(message.guild.commandPrefix+'mtrng'+/^ ([0-9]*) ([0-9]*) ([0-9]*)+\b/)){
            var numberarray=[]
            var numbertotal=0
